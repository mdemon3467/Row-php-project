...
//user
$select_user = "SELECT * FROM users WHERE id= '$loged_id'";
$select_id_res = mysqli_query($db_connect,$select_user);
$select_id_assoc = mysqli_fetch_assoc($select_id_res);
...
$message_count = "SELECT COUNT(*) as total FROM messages WHERE status='deactive'";
$message_res_count = mysqli_query($db_connect,$message_count);
$sfter_assooc_count = mysqli_fetch_assoc($message_res_count);
?>
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from gymove.dexignzone.com/laravel/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Dec 2023 12:04:45 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <!-- Title -->
	<title>Gymove Laravel | Dashboard</title> 
	...
	<meta name="csrf-token" content="xFLqzqVT4MkdNcHgZHsrg31HVOv7i2yyXenRGlt8">
	...
	<meta property="og:title" content="Gymove - Fitness Bootstrap Laravel Admin Dashboard Template">
	...
	<meta property="og:image" content="https://gymove.dexignzone.com/xhtml/page-error-404.html">
	...
	<link rel="shortcut icon" type="image/png" href="images/favicon.png">
                    ...
                    <link href="/sage/admin_page/vendor/chartist/css/chartist.min.css" rel="stylesheet" type="text/css"/>
                    <link href="/sage/admin_page/vendor/owl-carousel/owl.carousel.css" rel="stylesheet" type="text/css"/>
            
    
     
                    <link href="/sage/admin_page/vendor/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css"/>
                    <link href="/sage/admin_page/css/style.css" rel="stylesheet" type="text/css"/>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo" aria-label="Gymove">
                <img class="logo-abbr" src="/SAGE/admin_page/images/logo.png" alt="">
                <img class="logo-compact" src="/SAGE/admin_page/images/logo-text.png" alt="">
                <img class="brand-title" src="/SAGE/admin_page/images/logo-text.png" alt="">
            </a>
						...
						<ul class="contacts">
							...
							<li class="active dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="/sage/admin_page/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="/sage/admin_page/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="/sage/admin_page/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="/sage/admin_page/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="/sage/admin_page/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
					...
					<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
								<img src="/sage/admin_page/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
							</div>
						...
						<div class="d-flex justify-content-end mb-4">
							...
							<div class="img_cont_msg">
						<img src="/sage/admin_page/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
							</div>
						</div>
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
		...
		<nav class="navbar navbar-expand">
			<div class="collapse navbar-collapse justify-content-between">
				...
				<ul class="navbar-nav header-right">
					<li class="nav-item">
						<form>
						<input type="hidden" name="_token" value="xFLqzqVT4MkdNcHgZHsrg31HVOv7i2yyXenRGlt8">							<div class="input-group search-area d-lg-inline-flex d-none me-3">
					...
					<li class="nav-item dropdown notification_dropdown">
						<a class="nav-link  ai-icon" href="javascript:void(0)" aria-label="bell" role="button" data-bs-toggle="dropdown">
							...
							<div class="pulse-css"><?=($sfter_assooc_count['total'] <=9)?$sfter_assooc_count['total']:'9+'?></div>
						</a>
						<div class="dropdown-menu rounded dropdown-menu-end">
							<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
								<ul class="timeline">
									<?php foreach($message_res as $msg){ ?>
									<a href="/sage/message/view.php?id=<?=$msg['id']?>">
										<li class="<?=($msg['status']=='deactive')?'bg-light':''?>">
											<div class="timeline-panel">
												<!-- <div class="media me-2">
													<img alt="image" width="50" src="/sage/admin_page/images/avatar/1.jpg">
												</div> -->
												<div class="media-body">
													<h6 class="mb-1"><?=$msg['name']?></h6>
													<small class="d-block"><?=substr($msg['message'],0,40).'...'?></small>
												</div>
											</div>
										</li>
									</a>
							...
							<a class="all-notification" href="../message/message.php">See all notifications <i class="ti-arrow-right"></i></a>
						</div>
					</li>
					<!-- <li class="nav-item dropdown notification_dropdown">
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
							<?php if($select_id_assoc['user_photo'] != null){ ?>
								<img src="/sage/upload/user_image/<?=$select_id_assoc['user_photo']?>"/>
							<?php } 
							else{ ?>
								<img src="/SAGE/admin_page/images/profile/17.jpg" width="20" alt="">
							<?php } ?>

							<div class="header-info">
								<span class="text-black"><strong><?=$select_id_assoc['name']?></strong></span>
								<p class="fs-12 mb-0">Super Admin</p>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							<a href="../user/profile_edit.php" class="dropdown-item ai-icon">
 ...
 <!--**********************************
	...
	<div class="deznav-scroll">
		<ul class="metismenu" id="menu">
			<li><a class="has-arrow ai-icon" href="../admin_page/admin.php">
					<i class="flaticon-381-networking"></i>
					<span class="nav-text">Dashboard</span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="../expertise/skills_add.php">
			...
			<li><a class="has-arrow ai-icon" href="../user/user_list.php">
					<i class="flaticon-381-television"></i>
					<span class="nav-text">Users</span>
				</a>
			</li>

			<li><a class="has-arrow ai-icon" href="/sage/logo/logo.php" aria-expanded="false">
					<i class="flaticon-381-compact-disc-1"></i>
					<span class="nav-text">Logo<span class="badge badge-danger badge-xs ms-1">NEW</span></span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/sage/about/about.php">
					<i class="flaticon-381-briefcase"></i>
					<span class="nav-text">About<span class="badge badge-danger badge-xs ms-1">NEW</span></span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/sage/Services/service.php">
					<i class="flaticon-381-controls-3"></i>
					<span class="nav-text">Services</span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/sage/protfolio/protfolio.php">
					<i class="flaticon-381-internet"></i>
					<span class="nav-text">protfolio</span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/sage/team/add_team.php">
					<i class="flaticon-381-heart"></i>
					<span class="nav-text">team</span>
				</a>
			</li>
			<li><a class="has-arrow ai-icon" href="/sage/message/message.php">
		...
		<div class="add-menu-sidebar">
			<img src="/sage/admin_page/images/calendar.png" alt="" class="me-3">
